...
- Subject-keyword matches in the primary correspondence language (English example: application, interview, position, role, offer, "next steps", recruiter, recruiting, hiring, candidacy, "thank you for applying")
